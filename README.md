...
The project models employees, job postings, and companies, providing tools to assess
hiring suitability using structured data and vector-based similarity measures.

At career fairs, candidates provide information about their skills, education, and
past experience, while recruiters seek the best matches for open positions. This
system is designed to make employee-job matching clear, fair, and auditable. Each
recommendation and score can be traced back to the underlying data.
